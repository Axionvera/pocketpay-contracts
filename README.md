...
├── README.md
├── docs/
│   └── reviewer-evidence-checklist.md   # Maintainer PR evidence review guide
└── contracts/
    └── savings_vault/
...
- [Reviewer Evidence Checklist](docs/reviewer-evidence-checklist.md) – Maintainer checklist for scope, implementation, tests, exact-head CI, acceptance criteria, documentation impact, risk, and review outcomes.
