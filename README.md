...
- [Authorisation Rules Matrix](docs/authorisation-rules.md) – Public contract function authorisation requirements, caller expectations, and cross-user security boundaries.
