...
- [Contract API Reference](docs/api-reference.md) – Detailed reference for all public functions, including parameters, auth requirements, state changes, and errors.
