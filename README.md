...
- [Amount Normalisation Reference](docs/amount-normalization.md) - Rules, precision assumptions, minimum values, and unit definitions for vault deposits and balances.
