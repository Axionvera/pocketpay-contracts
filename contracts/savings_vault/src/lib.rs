...
/// * `Lock(Address, u64)` - An individual time-lock entry record for a user and lock ID
...
impl SavingsVault {
    ...
    pub fn withdraw(env: Env, user: Address, amount: i128) {
        ...
        let new_locked = Self::get_locked_balance(env.clone(), user.clone());
